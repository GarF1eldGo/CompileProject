int myStrcmp(char preCourseName[100],int len1,char takenCourseName[100][100],int len2){
    int flag = 1;
    int i = 0;
    int j = 0;
...
int boolExpression(char name[100],char token[100],int begin1,int len1,int preCourseTrue[100],int begin2,int len2){
