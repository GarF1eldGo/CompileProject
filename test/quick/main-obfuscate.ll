; ModuleID = 'quick/main-obfuscate.bc'
source_filename = "module"

@_Const_String_ = private global [3 x i8] c"\0FN\00"
@_Const_String_.1 = private global [3 x i8] c"\0FN\00"
@_Const_String_.2 = private global [4 x i8] c"\0FN \00"
...
forloop14:                                        ; preds = %foradd13, %forcont
  ...
  %tmpvar19 = getelementptr inbounds [100000 x i32], [100000 x i32]* %numArray, i32 0, i32 %tmpvar18
  %tmpvar20 = load i32, i32* %tmpvar19, align 4
  %4 = call i8* @__decrypt(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @_Const_String_.2, i32 0, i32 0))
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @_Const_String_.2, i32 0, i32 0), i32 %tmpvar20)
  %5 = call i8* @__encrypt(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @_Const_String_.2, i32 0, i32 0))
  br label %foradd13
