...
@_Const_String_ = private constant [3 x i8] c"%c\00"
@_Const_String_.1 = private constant [3 x i8] c"%c\00"
@_Const_String_.2 = private constant [12 x i8] c"GPA: %0.1f\0A\00"
@_Const_String_.3 = private constant [21 x i8] c"Hours Attempted: %d\0A\00"
@_Const_String_.4 = private constant [21 x i8] c"Hours Completed: %d\0A\00"
@_Const_String_.5 = private constant [24 x i8] c"Credits Remaining: %d\0A\0A\00"
@_Const_String_.6 = private constant [31 x i8] c"Possible Courses to Take Next\0A\00"
@_Const_String_.7 = private constant [27 x i8] c"  None - Congratulations!\0A\00"
@_Const_String_.8 = private constant [5 x i8] c"%c%c\00"
@_Const_String_.9 = private constant [3 x i8] c"%c\00"
@_Const_String_.10 = private constant [3 x i8] c"%c\00"
@_Const_String_.11 = private constant [5 x i8] c"%c%c\00"
@_Const_String_.12 = private constant [3 x i8] c"%c\00"
@_Const_String_.13 = private constant [3 x i8] c"%c\00"
...
merge204:                                         ; preds = %else203, %merge211
...
merge383:                                         ; preds = %else382, %then381
...
merge576:                                         ; preds = %else575, %forcont581
  br label %merge400
