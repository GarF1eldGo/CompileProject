; ModuleID = 'matrix/main-obfuscate.bc'
source_filename = "module"

@_Const_String_ = private global [6 x i8] c"\0FN\0A\0FN\00"
@_Const_String_.1 = private global [4 x i8] c"\0F\1CN\00"
@_Const_String_.2 = private global [6 x i8] c"\0FN\0A\0FN\00"
@_Const_String_.3 = private global [4 x i8] c"\0F\1CN\00"
@_Const_String_.4 = private global [25 x i8] c"cDIEGZK^CHFO\0AnCGODYCEDY \00"
@_Const_String_.5 = private global [5 x i8] c"\0F\1B\1AN\00"
@_Const_String_.6 = private global [2 x i8] c" \00"
...
forcont:                                          ; preds = %foradd, %main
  %2 = call i8* @__decrypt(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @_Const_String_.2, i32 0, i32 0))
  %scanf24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @_Const_String_.2, i32 0, i32 0), i32* %Mb, i32* %Nb)
  %3 = call i8* @__encrypt(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @_Const_String_.2, i32 0, i32 0))
...
forloop6:                                         ; preds = %foradd5, %forloop
  ...
  %4 = call i8* @__decrypt(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @_Const_String_.1, i32 0, i32 0))
  %scanf14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @_Const_String_.1, i32 0, i32 0), i32* %tmpvar13)
  %5 = call i8* @__encrypt(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @_Const_String_.1, i32 0, i32 0))
  br label %foradd5
...
forloop35:                                        ; preds = %foradd34, %forloop28
  ...
  %6 = call i8* @__decrypt(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @_Const_String_.3, i32 0, i32 0))
  %scanf43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @_Const_String_.3, i32 0, i32 0), i32* %tmpvar42)
  %7 = call i8* @__encrypt(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @_Const_String_.3, i32 0, i32 0))
  br label %foradd34
...
then:                                             ; preds = %forcont26
  %8 = call i8* @__decrypt(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @_Const_String_.4, i32 0, i32 0))
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @_Const_String_.4, i32 0, i32 0))
  %9 = call i8* @__encrypt(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @_Const_String_.4, i32 0, i32 0))
  ret i32 0
...
forloop123:                                       ; preds = %foradd122, %forloop116
  ...
  %11 = call i8* @__decrypt(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @_Const_String_.5, i32 0, i32 0))
  %printf132 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @_Const_String_.5, i32 0, i32 0), i32 %tmpvar131)
  %12 = call i8* @__encrypt(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @_Const_String_.5, i32 0, i32 0))
  br label %foradd122
...
forcont121:                                       ; preds = %foradd122, %forloop116
  %13 = call i8* @__decrypt(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @_Const_String_.6, i32 0, i32 0))
  %printf138 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @_Const_String_.6, i32 0, i32 0))
  %14 = call i8* @__encrypt(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @_Const_String_.6, i32 0, i32 0))
  br label %foradd115
}
