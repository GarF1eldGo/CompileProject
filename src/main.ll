...
forcont:                                          ; preds = %forloop, %main
  ...
  %tmpvar15 = load i32, i32* %num, align 4
  %tmpcmp16 = icmp slt i32 %tmpvar14, %tmpvar15
  br i1 %tmpcmp16, label %forloop12, label %forcont13

forloop12:                                        ; preds = %forloop12, %forcont
  %tmpvar17 = load i32, i32* %i, align 4
  %tmpvar18 = getelementptr inbounds [100000 x i32], [100000 x i32]* %numArray, i32 0, i32 %tmpvar17
  %tmpvar19 = load i32, i32* %tmpvar18, align 4
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @_Const_String_.2, i32 0, i32 0), i32 %tmpvar19)
  ...
  %tmpvar23 = load i32, i32* %num, align 4
  %tmpcmp24 = icmp slt i32 %tmpvar22, %tmpvar23
  br i1 %tmpcmp24, label %forloop12, label %forcont13

forcont13:                                        ; preds = %forloop12, %forcont
  ret i32 0
}
